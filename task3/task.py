...
def main(json_a, json_b):
    ...
    return {"kernel": kernel, "consistent_ranking": consistent_ranking}

if __name__ == "__main__":
    json_a = read_json_file('a_range.json')
    json_b = read_json_file('b_range.json')
    json_c = read_json_file('c_range.json')
